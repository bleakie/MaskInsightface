...
class FaceImageIter(io.DataIter):
    ...
    def __init__(self, batch_size, data_shape,
        ...
        # self.CenterCrop = mx.image.RandomSizedCropAug()
            ...
            while i < batch_size:
                ...
                if self.shelter:
                    ...
                    if _rd == 1:
                        ...
                        _data[ymin:ymax, xmin:xmax, :] = (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255))
                data = [_data]
                try:
